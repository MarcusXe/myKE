...
import com.example.xeby.myke.Utils.URLManager;
...
public class CourseService {
    ...
    public <T extends List<Classs>> void getCourse(String username, final HttpConnection.HttpCallBack<T> callBack) throws IOException {
        //因为xh为学号，需要自己设置
